...
**布局最终态**：
```
Framework.Kernel / Framework.Foundation / Framework(L1 能力：UI/UiTargets/宿主/通用遮罩件/编排原语)
...
L3 HotUpdate：RuntimeCatalogBootstrap 经 Modules.Use 登记 GuideModule/RedDotModule
```
